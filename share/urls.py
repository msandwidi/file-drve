...
urlpatterns = [
    ...
    path('dossier/<slug:slug>/download', views.download_shared_file_view, name='download-shared-folder'),
    path('dossier/<slug:slug>/delete', views.delete_shared_file_view, name='delete-shared-folder'),
    path('dossier/<slug:slug>/copier', views.copy_shared_file_view, name='copy-shared-folder'),
